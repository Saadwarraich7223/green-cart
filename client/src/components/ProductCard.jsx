...
const ProductCard = ({ product }) => {
  ...
  return (
    product && (
      <motion.div
        className="rounded-lg justify-self-center overflow-hidden shadow-sm border border-gray-400/30 md:px-4 px-3 py-4 bg-white sm:min-w-40   min-w-50 max-w-56 w-full"
