...
const ProductCard = ({ product }) => {
  ...
  return (
    product && (
      ...
      >
        <div className="cursor-pointer flex items-center justify-center px-2 mb-3 min-h-30 overflow-hidden rounded-md bg-gray-100/90 py-4">
          <motion.img
            variants={imageVariants}
            className="max-w-26 min-h-40 md:max-w-36  object-contain"
            src={product.image[0]}
            alt={product.name}
          />
        </div>
